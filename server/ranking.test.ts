  ...
  it("deve validar que campo 'app' contém valores válidos", async () => {
    ...
    for (const device of allDevices) {
      if (device.app) {
        ...
        const validApps = ["OuroPro", "Maximus", "Maximus Player", "Ultra Player", "Fusion", "Prestige", "Optimus", "Império Play", "Infinitus", "Supremus", "Evolux", "Ominus", "Magnus", "Magnus TV", "Excellence", "Nexus", "Outro"];
