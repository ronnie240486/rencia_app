...
## Correções Expo Go e Interactive Player (23/07/2026)
- [x] Corrigido erro de sintaxe no endpoint /api/v5/heartbeat (chave de fechamento extra)
- [x] Endpoint /api/v5/check_mac.php - Removido redirecionamento duplicado
- [x] Endpoint /api/v5/check_mac.php - Implementado auto-cadastro de MACs novos
- [x] Endpoint /player_api.php - Adicionado ao whitelist do middleware Vite
- [x] Middleware CORS - Adicionado headers para permitir requisições cross-origin
- [x] Campo app - Corrigido para sempre ser "OuroPro" ao salvar dispositivos
- [x] Expo Go - MAC BD:4B:ED:63:8A:2F cadastrado e funcionando
- [x] Expo Go - MAC A7:54:62:3F:DC:9C cadastrado e funcionando (novo)
- [x] Interactive Player - MAC 2F:97:6F:BF:8A:00 cadastrado e funcionando
- [x] Dispositivos - Aparecem como online no dashboard
- [x] Endpoints Xtream Codes - Todos funcionando (/player_api.php, /api/v5/check_mac.php, /api/v5/heartbeat)
- [x] Testes vitest - 30/30 passando
- [x] Documentação - APK_COMPATIBILITY_TEST.md criado
