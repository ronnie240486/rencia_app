        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Personalize cores, mensagens e configurações do aplicativo</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <TabsContent value="tema" className="space-y-4 mt-4">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Personalize a cor primária e tema do painel.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-5">
                      <div className="space-y-2">
                        <Label className="font-semibold">Cor Primária (Botões, Links)</Label>
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {COLOR_PRESETS.map(p => (
                            <button
                              key={p.value}
                              onClick={() => handleChange("primary_color", p.value)}
                              className="px-3 py-1 rounded text-xs border border-border hover:border-primary"
                              style={{ backgroundColor: p.value, color: "#fff" }}
                              title={p.name}
                            >
                              {p.name}
                            </button>
                      ...
                      <div className="space-y-2">
                        <Label className="font-semibold">Cor da Sidebar</Label>
                        <div className="flex gap-3 items-center">
                          <input
                            type="color"
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {SIDEBAR_PRESETS.map(p => (
                            <button
                              key={p.value}
                              onClick={() => handleChange("sidebar_color", p.value)}
                              className="px-3 py-1 rounded text-xs border border-border hover:border-primary text-white"
                      ...
                      <div className="space-y-2">
                        <Label className="font-semibold">Cor do Texto (Foreground)</Label>
                        <div className="flex gap-3 items-center">
                          <input
                            type="color"
                          ...
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            onClick={() => handleChange("text_color", "")}
                          >
                            Padrão
                          </Button>
                        </div>
                ...
                <TabsContent value="chatbot" className="space-y-4 mt-4">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Configure mensagens automáticas para avisar clientes sobre vencimento de assinatura.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-5">
                      <div className="space-y-2">
                        <Label className="font-semibold">Dias de antecedência para aviso</Label>
                        <Input
                          type="number"
                          value={form.chatbot_dias_aviso || "3"}
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                          O sistema enviará mensagens de aviso quando faltarem X dias para o vencimento.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          rows={4}
                          placeholder="Olá {nome}! Sua assinatura vence em {dias} dia(s) ({data}). Renove agora para não perder o acesso! 😊"
                        />
                        <p className="text-xs text-muted-foreground">
                          Use <code>{'{nome}'}</code>, <code>{'{dias}'}</code> e <code>{'{data}'}</code> como placeholders.
                        </p>
                      </div>
                      ...
                      <Button
                        ...
                        className="w-full"
                      >
                        {sendingTest ? <Loader2 size={16} className="animate-spin mr-2" /> : "✉️"}
                        {sendingTest ? "Enviando..." : "Testar Mensagem"}
                      </Button>
