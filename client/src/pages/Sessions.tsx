...
export default function Sessions() {
  ...
  return <AdminLayout title="Controle de Sessões"><div className="space-y-6">
    ...
    <div className="grid gap-3 sm:grid-cols-3"><Metric icon={<Wifi size={18} />} label="Sessões ativas" value={active.length} tone="text-emerald-600" /><Metric icon={<AlertTriangle size={18} />} label="MACs suspeitos" value={suspicious.length} tone="text-amber-600" /><Metric icon={<MonitorSmartphone size={18} />} label="Dispositivos" value={sessions.length} tone="text-primary" /></div>
