...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Cadastros das Revendas", href: "/cadastros-revendas", icon: <ClipboardList size={18} />, ownerOnly: true, permissionKey: "reseller_finance" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Supreme", href: "/aplicativos/supremus", icon: <Shield size={18} />, ownerOnly: true, permissionKey: "app_settings" },
